...
// It takes an opentracing.Tracer as a parameter and initializes the
// mux field with a new instance of http.ServeMux and sets the tracer
// field with the provided tracer.
