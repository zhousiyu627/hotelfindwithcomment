...
func dataGeoJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/geo.json", size: 519, mode: os.FileMode(420), modTime: time.Unix(1688147737, 0)}
...
func dataHotelsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/hotels.json", size: 3702, mode: os.FileMode(420), modTime: time.Unix(1688147737, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataInventoryJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/inventory.json", size: 993, mode: os.FileMode(420), modTime: time.Unix(1688147737, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
